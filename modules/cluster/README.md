...
| [alicloud_key_pair.cluster_key](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/key_pair) | resource |
...
| <a name="input_kubelet_configuration_kube_reserved"></a> [kubelet\_configuration\_kube\_reserved](#input\_kubelet\_configuration\_kube\_reserved) | Same as kubeReserved. The set of ResourceName=ResourceQuantity (e.g. cpu=200m,memory=150G) pairs that describe resources reserved for kubernetes system components. Currently, cpu, memory and local storage for root file system are supported | `map` | <pre>{<br>  "cpu": "250m",<br>  "ephemeral-storage": "1Gi",<br>  "memory": "512Mi"<br>}</pre> | no |
| <a name="input_kubelet_configuration_system_reserved"></a> [kubelet\_configuration\_system\_reserved](#input\_kubelet\_configuration\_system\_reserved) | Same as systemReserved. The set of ResourceName=ResourceQuantity (e.g. cpu=200m,memory=150G) pairs that describe resources reserved for non-kubernetes components. Currently, only cpu and memory are supported. | `map` | <pre>{<br>  "cpu": "250m",<br>  "memory": "512Mi"<br>}</pre> | no |
...
| <a name="input_resource_group_id"></a> [resource\_group\_id](#input\_resource\_group\_id) | Resource group in which cluster is created | `string` | `null` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_kubeconfig"></a> [kubeconfig](#output\_kubeconfig) | ACK Cluster kubeconfig file |
| <a name="output_kubeconfig_expiration"></a> [kubeconfig\_expiration](#output\_kubeconfig\_expiration) | ACK Cluster kubeconfig expiration time |
| <a name="output_kubeconfig_path"></a> [kubeconfig\_path](#output\_kubeconfig\_path) | n/a |
| <a name="output_private_key_openssh"></a> [private\_key\_openssh](#output\_private\_key\_openssh) | Private SSH key to access the VM |
<!-- END_TF_DOCS -->